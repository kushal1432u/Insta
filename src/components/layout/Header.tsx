      ...
      <div className="container flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline-block font-bold text-xl bg-gradient-to-r from-instagram-pink via-instagram-purple to-instagram-orange bg-clip-text text-transparent">
              InstaReel
            </span>
          </Link>
